        ...
        <section className="introduction">
          <div className="introduction-content">
            ...
            <div className="introduction-text">
              <p>
                Site com teste de grid para validar layout e breakpoints. Há
                dois arquivos de estilos csonfigurados: Um "responsivo" e outro
                "fixo" a qual é possível mudar pressionando os botões do menu
                acima. O grid é uma solução customizada usando Sass + Postcss
                gerando colunas usando a técnica mais tradicional com "floats" e
          ...
          <div className="introduction-content">
            ...
            <div className="introduction-text">
              <p>
                ...
                consiste em colunas fluidas mas ainda baseada no conceito
                proposto acima. Portanto em mobile há 2 colunas e tambem
                manatemos o breakpoint do "Grid Layout" apenas para referencia.
                A partir deste breakpoint, a layout trabalha com 12 colunas se
